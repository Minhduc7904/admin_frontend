...
export const API_ENDPOINTS = {
  ...
  ASSISTANT_SHIFTS: {
    ...
    BASE_SHIFTS: '/assistant-shifts/base',
    BASE_DETAIL: (id) => `/assistant-shifts/${id}/base`,
    COPY_BASE: '/assistant-shifts/base/copy',
    ...
    ASSIGNMENT_ACTIONS: {
      SWAP_REQUESTS: '/assistant-shift-assignment-actions/my/swap-requests',
      TRANSFER_REQUESTS: '/assistant-shift-assignment-actions/my/transfer-requests',
    },
