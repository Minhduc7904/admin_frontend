...
export const ClassAttendance = () => {
    ...
    return (
        <div className="bg-white border border-border rounded-sm p-8 text-center">
            <ClipboardCheck className="w-12 h-12 mx-auto mb-4 text-foreground-light" />
            <h3 className="text-lg font-semibold text-foreground mb-2">
                Điểm danh lớp "{courseClass.className}"
            </h3>
            <p className="text-foreground-light mb-4">
                Tính năng đang được phát triển. Bạn sẽ có thể quản lý điểm danh của lớp tại đây.
            </p>
        </div>
    );
};
