...
/**
 * ClassSchedule - Lịch học của một lớp
 */
export const ClassSchedule = () => {
    ...
    return (
        <div className="bg-white border border-border rounded-sm p-8 text-center">
            <Calendar className="w-12 h-12 mx-auto mb-4 text-foreground-light" />
            <h3 className="text-lg font-semibold text-foreground mb-2">
                Lịch học của lớp "{courseClass.className}"
            </h3>
            <p className="text-foreground-light mb-4">
                Tính năng đang được phát triển. Bạn sẽ có thể xem lịch học của lớp tại đây.
            </p>
        </div>
    );
};
