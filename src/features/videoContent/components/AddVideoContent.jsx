// src/features/videoContent/components/AddVideoContent.jsx
import { useState } from 'react'
import { useDispatch, useSelector } from 'react-redux'
import { Button, Textarea } from '../../../shared/components'
import { FileVideo } from 'lucide-react'
import {
    createVideoContentAsync,
    selectVideoContentLoadingCreate,
} from '../store/videoContentSlice'
import { MediaPickerModal } from '../../media/components'

export const AddVideoContent = ({ onClose, learningItemId, onSuccess }) => {
    const dispatch = useDispatch()
    const loadingCreate = useSelector(selectVideoContentLoadingCreate)
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await dispatch(createVideoContentAsync(data)).unwrap()
            onSuccess?.()
            onClose()
        } catch (error) {
