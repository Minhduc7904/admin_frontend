...
export const ExamQuestionsTab: React.FC<ExamQuestionsTabProps> = ({ examId }) => {
    ...
    // Mock data - questions in this exam
    ...
    const handleAddQuestion = () => {
        console.log('Add question to exam:', examId);
    };
    ...
    const handleDelete = (id: string) => {
        console.log('Remove question from exam:', id);
    };
